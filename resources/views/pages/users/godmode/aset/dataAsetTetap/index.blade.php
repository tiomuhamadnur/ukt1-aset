            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-3 text-left">
                            <div class="d-flex justify-content-start align-items-center flex-wrap">
                                ...
                                <a href="#" class="btn btn-primary mr-2 mb-2 mb-sm-0" data-toggle="modal"
                                    data-target="#modalCreate">Bulk Upload (Excel)</a>
                                <a href="{{ route('dataAsetTetap.create') }}"
                                ...
                                <a href="{{ route('dataAsetTetap.index') }}" class="btn btn-primary mr-2 mb-2 mb-sm-0"
                                    title="Reset Filter">
                    ...
                    <div class="row container">
                        <p><span class="font-weight-bolder">Note:</span> Data Aset Tetap di bawah merupakan Aset Tetap /
                            Fasilitas
                            UKT 1 yang sudah terinput ke sistem ASET APP.</p>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('detailAsetTetap.index') }}">
